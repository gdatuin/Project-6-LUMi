...
try {
    ...
    ");
    $reviewstatement->bindParam(':product_id', $product_id, PDO::PARAM_INT);
...
try {
    $ratingstatement = $db->prepare("SELECT AVG(rating) as average_rating FROM reviews WHERE product_id = :product_id");
    $ratingstatement->bindParam(':product_id', $product_id, PDO::PARAM_INT);
    $ratingstatement->execute();

    if ($ratingstatement->rowCount() > 0) {
...
<head>
    <meta charset="UTF-8">
    <title>
        <?= htmlspecialchars($product['product_name']) ?> - LUMi
    </title>
    <link rel="stylesheet" href="styles.css" />
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Bruno+Ace&family=Fugaz+One&family=Russo+One&display=swap"
        rel="stylesheet">
...
<body id="productPage">
    ...
    <main class="product-page">
        ...
        <div class="product-container">
            ...
            <div class="product-details">
                ...
                <a href="edit-product.php?id=<?= htmlspecialchars($product_id) ?>" class="edit-product-button">Edit
                    Product</a>
                <?php endif; ?>
                <h1>
        ...
        <section class="product-reviews">
            ...
            <div class="review-item">
                <p>Reviewer:
                    <?= !empty($review['username']) ? htmlspecialchars($review['username'], ENT_QUOTES, 'UTF-8') : htmlspecialchars($review['guest_name'], ENT_QUOTES, 'UTF-8'); ?>
                </p>
                <p>Rating:
   ...
   (($_SESSION['role'] == 'admin') || ($_SESSION['user_id'] == $review['user_id']))): ?>
                <form action="delete-review.php" class="delete-button" method="post"
                    onsubmit="return confirm('Are you sure you want to delete the review?');">
            ...
            <?= str_repeat('&#9733;', $i) . str_repeat('&#9734;', 5 - $i) ?>
                ...
                <br><button type="submit" name="submit_review" class="submit-review-button">Submit Review</button>
